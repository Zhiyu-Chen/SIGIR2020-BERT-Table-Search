...
from .modeling_bert import (BertConfig, BertPreTrainedModel, BertModel, BertForPreTraining,
                            ...
                            BertForTokenClassification, BertForQuestionAnswering, BertForWSC, BertForHybridWSC, BertForWiC, BertForRecord,BertForHybridTable, ## new model
...
from .modeling_xlnet import (XLNetConfig,
                             ...
                             XLNetForSequenceClassification, XLNetForQuestionAnswering, XLNetForWiC,
...
from .modeling_roberta import (RobertaConfig, RobertaForMaskedLM, RobertaModel, RobertaForSequenceClassification, RobertaForWSC, RobertaForWiC,
